...
//
//let localRepoLocation = documentURL.appendingPathComponent("demo_site")
//let remoteRepoLocation = "git@github.com:kimpucky/demo_site.git"
//
...
//        try credentialManager.addOrUpdate(nil, Credential(id: "MyGithub", kind: .password, targetURL: "https://github.com/kimpucky/", userName: "YOUR_USERNAME", password: "YOUR_ACCESS_TOKEN"))
