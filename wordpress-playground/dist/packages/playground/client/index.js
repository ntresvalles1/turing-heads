...
const $a = async (e, { pluginZipFile: t, options: r = {} }, n) => {
  const s = t.name.split("/").pop() || "plugin.zip", i = Nr(s);
...
const Na = typeof globalThis.ErrorEvent == "function" ? globalThis.ErrorEvent : rn;
function Ca(e) {
...
`, ds = "\x1B[41m", Fa = "\x1B[1m", fs = "\x1B[0m", ps = "\x1B[K";
let hs = !1;
function Ma(e) {
  if (!hs) {
    hs = !0, console.log(`${ds}
  ...
  async #u(t, r) {
    ...
    try {
      ...
      if (t.files && Object.keys(t.files).length) {
        ...
        i["content-type"]?.startsWith("multipart/form-data") && (t.formData = Wa(
          t.body || ""
...
var xa = Object.defineProperty, Ja = Object.getOwnPropertyDescriptor, je = (e, t, r, n) => {
  for (var s = n > 1 ? void 0 : n ? Ja(t, r) : t, i = e.length - 1, a; i >= 0; i--)
    (a = e[i]) && (s = (n ? a(t, r, s) : a(s)) || s);
  return n && s && xa(t, r, s), s;
};
...
class ke {
   ...
   */
  constructor(t, r) {
    this.#e = [], this.#t = !1, this.#n = null, this.#r = {}, this.#i = [], t !== void 0 && this.initializeRuntime(t), r && (this.requestHandler = new qa(
      new Ha(this, r)
    ));
  }
  #e;
...
`;
  ...
  async #y() {
    ...
    try {
      ...
      this.functionsMaybeMissingFromAsyncify = Ia();
...
function Za(e) {
  return e && typeof e == "object" && typeof e.resource == "string" && Ya.includes(e.resource);
}
class dt {
  /**
  ...
  static create(t, { semaphore: r, progress: n }) {
    ...
    return s = new so(s), r && (s = new io(s, r)), s;
  }
  setPlayground(t) {
    this.playground = t;
  }
...
class sn extends dt {
  ...
  async resolve() {
    ...
    if (r = await Oa(
      r,
      this.progress?.loadingListener ?? eo
    ), r.status !== 200)
...
var Wr = { exports: {} }, Xs = {}, Ne = {}, Ot = {}, Xt = {}, G = {}, Qt = {};
(function(e) {
...
(function(e) {
  ...
  class l extends s {
    ...
    value(u, d) {
      ...
      S.set(E, C);
      const $ = this._scope[j] || (this._scope[j] = []), y = $.length;
      return $[y] = d.ref, C.setValue(d, { property: j, itemIndex: y }), C;
    }
    getValue(u, d) {
    ...
    _reduceValues(u, d, g = {}, C) {
      ...
      for (const E in u) {
        ...
        if (!S)
          continue;
        const $ = g[E] = g[E] || /* @__PURE__ */ new Map();
        S.forEach((y) => {
          if ($.has(y))
            return;
          $.set(y, n.Started);
...
(function(e) {
  ...
  class l extends i {
    constructor(o, h, N) {
      super(), this.lhs = o, this.rhs = h, this.sideEffects = N;
    }
    render({ _n: o }) {
  ...
  class j extends i {
    ...
    render(o) {
      return this.nodes.reduce((h, N) => h + N.render(o), "");
    }
    optimizeNodes() {
      const { nodes: o } = this;
      let h = o.length;
      for (; h--; ) {
        const N = o[h].optimizeNodes();
        Array.isArray(N) ? o.splice(h, 1, ...N) : N ? o[h] = N : o.splice(h, 1);
      }
    ...
    optimizeNames(o, h) {
      ...
      for (; M--; ) {
        const U = N[M];
        U.optimizeNames(o, h) || (Ze(o, U.names), N.splice(M, 1));
      }
  ...
  class y extends E {
    ...
    optimizeNames(o, h) {
      var N;
      if (this.else = (N = this.else) === null || N === void 0 ? void 0 : N.optimizeNames(o, h), !!(super.optimizeNames(o, h) || this.else))
  ...
  class k extends T {
    ...
    render(o) {
      const h = o.es5 ? r.varKinds.var : this.varKind, { name: N, from: M, to: U } = this;
      return `for(${h} ${N}=${M}; ${N}<${U}; ${N}++)` + super.render(o);
    }
    get names() {
  ...
  class _ extends E {
    constructor(o, h, N) {
      super(), this.name = o, this.args = h, this.async = N;
    }
    render(o) {
...
` : "" }, this._extScope = o, this._scope = new r.Scope({ parent: o }), this._nodes = [new S()];
    ...
    scopeValue(o, h) {
      const N = this._extScope.value(o, h);
    ...
    _def(o, h, N, M) {
      ...
      return N !== void 0 && M && (this._constants[U.str] = N), this._leafNode(new a(o, U, N)), U;
    }
    // `const` declaration (`var` in es5 mode)
    const(o, h, N) {
      return this._def(r.varKinds.const, o, h, N);
    }
    // `let` declaration with optional assignment (`var` in es5 mode)
    let(o, h, N) {
      return this._def(r.varKinds.let, o, h, N);
    }
    // `var` declaration with optional assignment
    var(o, h, N) {
      return this._def(r.varKinds.var, o, h, N);
    }
    // assignment code
    assign(o, h, N) {
      return this._leafNode(new l(o, h, N));
    }
    // `+=` code
    add(o, h) {
    ...
    if(o, h, N) {
      if (this._blockNode(new y(o)), h && N)
    ...
    forRange(o, h, N, M, U = this.opts.es5 ? r.varKinds.var : r.varKinds.let) {
      const x = this._scope.toName(o);
      return this._for(new k(U, x, h, N), () => M(x));
    }
    ...
    forOf(o, h, N, M = r.varKinds.const) {
      ...
      if (this.opts.es5) {
        ...
        return this.forRange("_i", 0, (0, t._)`${x}.length`, (Y) => {
          this.var(U, (0, t._)`${x}[${Y}]`), N(U);
        });
      }
      return this._for(new D("of", M, U, h), () => N(U));
    }
    // `for-in` statement.
    ...
    forIn(o, h, N, M = this.opts.es5 ? r.varKinds.var : r.varKinds.const) {
      ...
      const U = this._scope.toName(o);
      return this._for(new D("in", M, U, h), () => N(U));
    }
    // end `for` loop
    endFor() {
    ...
    try(o, h, N) {
      ...
      return N && (this._currNode = M.finally = new B(), this.code(N)), this._endBlockNode(H, B);
    }
    // `throw` statement
    throw(o) {
    ...
    endBlock(o) {
      ...
      if (N < 0 || o !== void 0 && N !== o)
        throw new Error(`CodeGen: wrong number of nodes: ${N} vs ${o} expected`);
      return this._nodes.length = h, this;
    }
    // `function` heading (or definition if funcBody is passed)
    func(o, h = t.nil, N, M) {
      return this._blockNode(new _(o, h, N)), M && this.code(M).endFunc(), this;
    }
    ...
    _endBlockNode(o, h) {
      ...
      if (N instanceof o || h && N instanceof h)
  ...
  function de(w, o, h) {
    ...
    if (!M(w))
      return w;
    return new t._Code(w._items.reduce((U, x) => (x instanceof t.Name && (x = N(x)), x instanceof t._Code ? U.push(...x._items) : U.push(x), U), []));
    function N(U) {
      const x = h[U.str];
  ...
  e.not = Qe;
  const ft = v(e.operators.AND);
  function kt(...w) {
    return w.reduce(ft);
  }
  e.and = kt;
  const pt = v(e.operators.OR);
  function F(...w) {
    return w.reduce(pt);
  }
  e.or = F;
...
(function(e) {
  ...
  e.toHash = n;
  function s(_, O) {
    return typeof O == "boolean" ? O : Object.keys(O).length === 0 ? !0 : (i(_, O), !a(O, _.self.RULES.all));
  }
  e.alwaysValidSchema = s;
  function i(_, O = _.schema) {
  ...
  function p({ topSchemaRef: _, schemaPath: O }, A, H, B) {
    if (!B) {
    ...
    return (0, t._)`${_}${O}${(0, t.getProperty)(H)}`;
  }
  e.schemaRefOrVal = p;
  function u(_) {
  ...
  e.eachItem = j;
  function E({ mergeNames: _, mergeToName: O, mergeValues: A, resultToName: H }) {
    return (B, ae, Z, be) => {
      const de = Z === void 0 ? ae : Z instanceof t.Name ? (ae instanceof t.Name ? _(B, ae, Z) : O(B, ae, Z), Z) : ae instanceof t.Name ? (O(B, Z, ae), ae) : A(ae, Z);
      return be === t.Name && !(de instanceof t.Name) ? H(B, de) : de;
    };
  }
  e.mergeEvaluated = {
    props: E({
      mergeNames: (_, O, A) => _.if((0, t._)`${A} !== true && ${O} !== undefined`, () => {
        _.if((0, t._)`${O} === true`, () => _.assign(A, !0), () => _.assign(A, (0, t._)`${A} || {}`).code((0, t._)`Object.assign(${A}, ${O})`));
      }),
      mergeToName: (_, O, A) => _.if((0, t._)`${A} !== true`, () => {
        O === !0 ? _.assign(A, !0) : (_.assign(A, (0, t._)`${A} || {}`), $(_, A, O));
      }),
      mergeValues: (_, O) => _ === !0 ? !0 : { ..._, ...O },
      resultToName: S
    }),
    items: E({
      mergeNames: (_, O, A) => _.if((0, t._)`${A} !== true && ${O} !== undefined`, () => _.assign(A, (0, t._)`${O} === true ? true : ${A} > ${O} ? ${A} : ${O}`)),
      mergeToName: (_, O, A) => _.if((0, t._)`${A} !== true`, () => _.assign(A, O === !0 ? !0 : (0, t._)`${A} > ${O} ? ${A} : ${O}`)),
      mergeValues: (_, O) => _ === !0 ? !0 : Math.max(_, O),
      resultToName: (_, O) => _.var("items", O)
    })
  };
  function S(_, O) {
    if (O === !0)
    ...
    return O !== void 0 && $(_, A, O), A;
  }
  e.evaluatedPropsToName = S;
  function $(_, O, A) {
    Object.keys(A).forEach((H) => _.assign((0, t._)`${O}${(0, t.getProperty)(H)}`, !0));
  }
  e.setEvaluated = $;
  const y = {};
  function T(_, O) {
    return _.scopeValue("func", {
      ref: O,
      code: y[O.code] || (y[O.code] = new r._Code(O.code))
    });
  }
  e.useFunc = T;
  var R;
  ...
  e.getErrorPath = k;
  function D(_, O, A = _.opts.strictSchema) {
    if (A) {
      if (O = `strict mode: ${O}`, A === !0)
        throw new Error(O);
      _.self.logger.warn(O);
    }
  }
  e.checkStrictMode = D;
})(X);
...
(function(e) {
  ...
  e.keywordError = {
    ...
    message: ({ keyword: $, schemaType: y }) => y ? (0, t.str)`"${$}" keyword must be ${y} ($data)` : (0, t.str)`"${$}" keyword is invalid ($data)`
  };
  function s($, y = e.keywordError, T, R) {
    const { it: k } = $, { gen: D, compositeRule: _, allErrors: O } = k, A = g($, y, T);
    R ?? (_ || O) ? p(D, A) : u(k, (0, t._)`[${A}]`);
  }
  e.reportError = s;
  function i($, y = e.keywordError, T) {
    const { it: R } = $, { gen: k, compositeRule: D, allErrors: _ } = R, O = g($, y, T);
    p(k, O), D || _ || u(R, n.default.vErrors);
  }
  e.reportExtraError = i;
  function a($, y) {
    $.assign(n.default.errors, y), $.if((0, t._)`${n.default.vErrors} !== null`, () => $.if(y, () => $.assign((0, t._)`${n.default.vErrors}.length`, y), () => $.assign(n.default.vErrors, null)));
  }
  e.resetErrorsCount = a;
  function l({ gen: $, keyword: y, schemaValue: T, data: R, errsCount: k, it: D }) {
    if (k === void 0)
      throw new Error("ajv implementation error");
    const _ = $.name("err");
    $.forRange("i", k, n.default.errors, (O) => {
      $.const(_, (0, t._)`${n.default.vErrors}[${O}]`), $.if((0, t._)`${_}.instancePath === undefined`, () => $.assign((0, t._)`${_}.instancePath`, (0, t.strConcat)(n.default.instancePath, D.errorPath))), $.assign((0, t._)`${_}.schemaPath`, (0, t.str)`${D.errSchemaPath}/${y}`), D.opts.verbose && ($.assign((0, t._)`${_}.schema`, T), $.assign((0, t._)`${_}.data`, R));
    });
  }
  e.extendErrors = l;
  function p($, y) {
    const T = $.const("err", y);
    $.if((0, t._)`${n.default.vErrors} === null`, () => $.assign(n.default.vErrors, (0, t._)`[${T}]`), (0, t._)`${n.default.vErrors}.push(${T})`), $.code((0, t._)`${n.default.errors}++`);
  }
  function u($, y) {
    const { gen: T, validateName: R, schemaEnv: k } = $;
    k.$async ? T.throw((0, t._)`new ${$.ValidationError}(${y})`) : (T.assign((0, t._)`${R}.errors`, y), T.return(!1));
  }
  const d = {
  ...
  function C($, y, T = {}) {
    ...
    return S($, y, D), R.object(...D);
  }
  function j({ errorPath: $ }, { instancePath: y }) {
    const T = y ? (0, t.str)`${$}${(0, r.getErrorPath)(y, r.Type.Str)}` : $;
    return [n.default.instancePath, (0, t.strConcat)(n.default.instancePath, T)];
  }
  function E({ keyword: $, it: { errSchemaPath: y } }, { schemaPath: T, parentSchema: R }) {
    let k = R ? y : (0, t.str)`${y}/${$}`;
    return T && (k = (0, t.str)`${k}${(0, r.getErrorPath)(T, r.Type.Str)}`), [d.schemaPath, k];
  }
  function S($, { params: y, message: T }, R) {
    const { keyword: k, data: D, schemaValue: _, it: O } = $, { opts: A, propertyName: H, topSchemaRef: B, schemaPath: ae } = O;
    R.push([d.keyword, k], [d.params, typeof y == "function" ? y($) : y || (0, t._)`{}`]), A.messages && R.push([d.message, typeof T == "function" ? T($) : T]), A.verbose && R.push([d.schema, _], [d.parentSchema, (0, t._)`${B}${ae}`], [n.default.data, D]), H && R.push([d.propertyName, H]);
  }
})(Xt);
Object.defineProperty(Ot, "__esModule", { value: !0 });
Ot.boolOrEmptySchema = Ot.topBoolOrEmptySchema = void 0;
const lo = Xt, uo = G, fo = Ve, po = {
  message: "boolean schema is false"
};
function ho(e) {
  const { gen: t, schema: r, validateName: n } = e;
  r === !1 ? ei(e, !1) : typeof r == "object" && r.$async === !0 ? t.return(fo.default.data) : (t.assign((0, uo._)`${n}.errors`, null), t.return(!0));
}
Ot.topBoolOrEmptySchema = ho;
function mo(e, t) {
  const { gen: r, schema: n } = e;
  n === !1 ? (r.var(t, !1), ei(e)) : r.var(t, !0);
}
Ot.boolOrEmptySchema = mo;
function ei(e, t) {
  ...
  (0, lo.reportError)(s, po, void 0, t);
}
var er = {}, lt = {};
...
function vo(e) {
  return typeof e == "string" && go.has(e);
}
lt.isJSONType = vo;
function $o() {
  const e = {
...
function _o({ schema: e, self: t }, r) {
  const n = t.RULES.types[r];
  return n && n !== !0 && ti(e, n);
}
He.schemaHasRulesForType = _o;
function ti(e, t) {
...
(function(e) {
  ...
  e.getJSONTypes = p;
  function u(R, k) {
    const { gen: D, data: _, opts: O } = R, A = g(k, O.coerceTypes), H = k.length > 0 && !(A.length === 0 && k.length === 1 && (0, r.schemaHasRulesForType)(R, k[0]));
    if (H) {
      const B = S(k, _, O.strictNumbers, a.Wrong);
      D.if(B, () => {
  ...
  function C(R, k, D) {
    const { gen: _, data: O, opts: A } = R, H = _.let("dataType", (0, s._)`typeof ${O}`), B = _.let("coerced", (0, s._)`undefined`);
    A.coerceTypes === "array" && _.if((0, s._)`${H} == 'object' && Array.isArray(${O}) && ${O}.length == 1`, () => _.assign(O, (0, s._)`${O}[0]`).assign(H, (0, s._)`typeof ${O}`).if(S(k, O, A.strictNumbers), () => _.assign(B, O))), _.if((0, s._)`${B} !== undefined`);
    for (const Z of D)
    ...
    function ae(Z) {
      switch (Z) {
        case "string":
          _.elseIf((0, s._)`${H} == "number" || ${H} == "boolean"`).assign(B, (0, s._)`"" + ${O}`).elseIf((0, s._)`${O} === null`).assign(B, (0, s._)`""`);
          return;
        case "number":
          _.elseIf((0, s._)`${H} == "boolean" || ${O} === null
              || (${H} == "string" && ${O} && ${O} == +${O})`).assign(B, (0, s._)`+${O}`);
          return;
        case "integer":
          _.elseIf((0, s._)`${H} === "boolean" || ${O} === null
              || (${H} === "string" && ${O} && ${O} == +${O} && !(${O} % 1))`).assign(B, (0, s._)`+${O}`);
          return;
        case "boolean":
          _.elseIf((0, s._)`${O} === "false" || ${O} === 0 || ${O} === null`).assign(B, !1).elseIf((0, s._)`${O} === "true" || ${O} === 1`).assign(B, !0);
          return;
        case "null":
          _.elseIf((0, s._)`${O} === "" || ${O} === 0 || ${O} === false`), _.assign(B, null);
          return;
        case "array":
          _.elseIf((0, s._)`${H} === "string" || ${H} === "number"
              || ${H} === "boolean" || ${O} === null`).assign(B, (0, s._)`[${O}]`);
      }
    }
  }
  ...
  function E(R, k, D, _ = a.Correct) {
    const O = _ === a.Correct ? s.operators.EQ : s.operators.NEQ;
    let A;
    switch (R) {
      case "null":
        return (0, s._)`${k} ${O} null`;
      case "array":
  ...
  function S(R, k, D, _) {
    ...
    if (A.array && A.object) {
      ...
      O = A.null ? H : (0, s._)`!${k} || ${H}`, delete A.null, delete A.array, delete A.object;
    } else
      O = s.nil;
    A.number && delete A.integer;
    for (const H in A)
      O = (0, s.and)(O, E(H, k, D, _));
    return O;
  }
  e.checkDataTypes = S;
  const $ = {
  ...
  e.reportTypeError = y;
  function T(R) {
    const { gen: k, data: D, schema: _ } = R, O = (0, i.schemaRefOrVal)(R, _, "type");
    return {
      gen: k,
      keyword: "type",
      data: D,
...
function bo(e, t) {
  ...
  if (t === "object" && r)
    ...
    t === "array" && Array.isArray(n) && n.forEach((s, i) => vs(e, i, s.default));
}
jr.assignDefaults = bo;
function vs(e, t, r) {
  ...
  if (s) {
    (0, wo.checkStrictMode)(e, `default is ignored for: ${l}`);
    return;
  }
...
K.checkReportMissingProp = Eo;
function So({ gen: e, data: t, it: { opts: r } }, n, s) {
  return (0, ne.or)(...n.map((i) => (0, ne.and)(ln(e, t, i, r.ownProperties), (0, ne._)`${s} = ${i}`)));
}
K.checkMissingProp = So;
function To(e, t) {
  e.setParams({ missingProperty: t }, !0), e.error();
}
K.reportMissingProp = To;
function ni(e) {
...
const Co = (0, ne._)`new RegExp`;
function jo({ gen: e, it: { opts: t } }, r) {
  const n = t.unicodeRegExp ? "u" : "", { regExp: s } = t.code, i = s(r, n);
  return e.scopeValue("pattern", {
    key: i.toString(),
    ref: i,
    code: (0, ne._)`${s.code === "new RegExp" ? Co : (0, Po.useFunc)(e, s)}(${r}, ${n})`
  });
}
K.usePattern = jo;
function ko(e) {
...
function Mo(e, t) {
  ...
  function C() {
    if (t.errors === !1)
      S(), t.modifying && $s(e), $(() => e.error());
    else {
      const y = t.async ? j() : E();
      t.modifying && $s(e), $(() => Uo(e, y));
    }
  }
  function j() {
  ...
  function S(y = t.async ? (0, ge._)`await ` : ge.nil) {
    ...
    n.assign(g, (0, ge._)`${y}${(0, Ao.callValidateCode)(e, d, T, R)}`, t.modifying);
  }
  function $(y) {
    var T;
...
function Uo(e, t) {
  ...
  r.if((0, ge._)`Array.isArray(${t})`, () => {
    r.assign(st.default.vErrors, (0, ge._)`${st.default.vErrors} === null ? ${t} : ${st.default.vErrors}.concat(${t})`).assign(st.default.errors, (0, ge._)`${st.default.vErrors}.length`), (0, Do.extendErrors)(e);
  }, () => e.error());
}
...
qe.validSchemaType = qo;
function Vo({ schema: e, opts: t, self: r, errSchemaPath: n }, s, i) {
...
qe.validateKeywordUsage = Vo;
var Ye = {};
Object.defineProperty(Ye, "__esModule", { value: !0 });
Ye.extendSubschemaMode = Ye.extendSubschemaData = Ye.getSubschema = void 0;
const Le = G, ai = X;
function zo(e, { keyword: t, schemaProp: r, schema: n, schemaPath: s, errSchemaPath: i, topSchemaRef: a }) {
...
Ye.getSubschema = zo;
function Ho(e, t, { dataProp: r, dataPropType: n, data: s, dataTypes: i, propertyName: a }) {
...
Ye.extendSubschemaData = Ho;
function Wo(e, { jtdDiscriminator: t, jtdMetadata: r, compositeRule: n, createErrors: s, allErrors: i }) {
  n !== void 0 && (e.compositeRule = n), s !== void 0 && (e.createErrors = s), i !== void 0 && (e.allErrors = i), e.jtdDiscriminator = t, e.jtdMetadata = r;
}
Ye.extendSubschemaMode = Wo;
    ...
    for (var d in n) {
      ...
      if (Array.isArray(g)) {
        ...
        if (g && typeof g == "object")
          for (var j in g)
            mr(e, t, r, g[j], s + "/" + d + "/" + Ko(j), i, s, d, n, j);
      } else
...
const Bo = X, xo = oi, Jo = Go, Yo = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function li(e) {
  ...
  for (const r in e) {
    if (r === "$ref")
      return 1 / 0;
    if (t++, !Yo.has(r) && (typeof e[r] == "object" && (0, Bo.eachItem)(e[r], (n) => t += li(n)), t === 1 / 0))
      return 1 / 0;
  }
  return t;
}
...
he.resolveUrl = ec;
const tc = /^[a-z_][-a-z0-9._]*$/i;
function rc(e, t) {
  if (typeof e == "boolean")
    return {};
  const { schemaId: r, uriResolver: n } = this.opts, s = Tt(e[r] || t), i = { "": s }, a = ui(n, s, !1), l = {}, p = /* @__PURE__ */ new Set();
  return Jo(e, { allKeys: !0 }, (g, C, j, E) => {
    if (E === void 0)
      return;
    const S = a + C;
    let $ = i[E];
    typeof g[r] == "string" && ($ = y.call(this, g[r])), T.call(this, g.$anchor), T.call(this, g.$dynamicAnchor), i[C] = $;
    function y(R) {
      const k = this.opts.uriResolver.resolve;
      if (R = Tt($ ? k($, R) : R), p.has(R))
        throw d(R);
      p.add(R);
      let D = this.refs[R];
...
const fi = Ot, _s = er, un = He, wr = er, nc = jr, Gt = qe, Mr = Ye, L = G, z = Ve, sc = he, We = X, zt = Xt;
function ic(e) {
  if (mi(e) && (yi(e), hi(e))) {
    cc(e);
    return;
...
function pi({ gen: e, validateName: t, schema: r, schemaEnv: n, opts: s }, i) {
  s.code.es5 ? e.func(t, (0, L._)`${z.default.data}, ${z.default.valCxt}`, n.$async, () => {
    e.code((0, L._)`"use strict"; ${ws(r, s)}`), oc(e, s), e.code(i);
  }) : e.func(t, (0, L._)`${z.default.data}, ${ac(s)}`, n.$async, () => e.code(ws(r, s)).code(i));
}
function ac(e) {
...
function cc(e) {
  ...
  pi(e, () => {
    r.$comment && t.$comment && vi(e), pc(e), n.let(z.default.vErrors, null), n.let(z.default.errors, 0), r.unevaluated && lc(e), gi(e), yc(e);
  });
}
function lc(e) {
...
function hc(e) {
  ...
  t && (e.baseId = (0, sc.resolveUrl)(e.opts.uriResolver, e.baseId, t));
}
function mc(e) {
...
function yc(e) {
  ...
  r.$async ? t.if((0, L._)`${z.default.errors} === 0`, () => t.return(z.default.data), () => t.throw((0, L._)`new ${s}(${z.default.vErrors})`)) : (t.assign((0, L._)`${n}.errors`, z.default.vErrors), i.unevaluated && gc(e), t.return((0, L._)`${z.default.errors} === 0`));
}
function gc({ gen: e, evaluated: t, props: r, items: n }) {
...
function Ps(e, t) {
  ...
  s && (0, nc.assignDefaults)(e, t.type), r.block(() => {
    for (const i of t.rules)
      (0, un.shouldUseRule)(n, i) && wi(e, i.keyword, i.definition, t.type);
  });
}
function vc(e, t) {
  e.schemaEnv.meta || !e.opts.strictTypes || ($c(e, t), e.opts.allowUnionTypes || _c(e, t), wc(e, e.dataTypes));
}
function $c(e, t) {
  if (t.length) {
    ...
    t.forEach((r) => {
      $i(e.dataTypes, r) || dn(e, `type "${r}" not allowed by context "${e.dataTypes.join(",")}"`);
    }), Pc(e, t);
  }
}
function _c(e, t) {
...
function wc(e, t) {
  ...
  for (const n in r) {
    ...
    if (typeof s == "object" && (0, un.shouldUseRule)(e.schema, s)) {
      ...
      i.length && !i.some((a) => bc(t, a)) && dn(e, `missing type "${i.join(",")}" for keyword "${n}"`);
    }
  }
}
function bc(e, t) {
...
function Pc(e, t) {
  ...
  for (const n of e.dataTypes)
    $i(t, n) ? r.push(n) : t.includes("integer") && n === "number" && r.push("integer");
  e.dataTypes = r;
}
function dn(e, t) {
...
const Te = G, Oc = tr, nt = Ve, Oe = he, Es = X, Nc = Ne;
class kr {
  constructor(t) {
    var r;
    this.refs = {}, this.dynamicAnchors = {};
    let n;
    typeof t.schema == "object" && (n = t.schema), this.schema = t.schema, this.schemaId = t.schemaId, this.root = t.root || this, this.baseId = (r = t.baseId) !== null && r !== void 0 ? r : (0, Oe.normalizeId)(n?.[t.schemaId || "$id"]), this.schemaPath = t.schemaPath, this.localRefs = t.localRefs, this.meta = t.meta, this.$async = n?.$async, this.refs = {};
  }
}
_e.SchemaEnv = kr;
function fn(e) {
  ...
  if (t)
    return t;
  const r = (0, Oe.getFullPath)(this.opts.uriResolver, e.root.baseId), { es5: n, lines: s } = this.opts.code, { ownProperties: i } = this.opts, a = new Te.CodeGen(this.scope, { es5: n, lines: s, ownProperties: i });
  let l;
...
function Ir(e, t) {
  const r = this.opts.uriResolver.parse(t), n = (0, Oe._getFullPath)(this.opts.uriResolver, r);
  let s = (0, Oe.getFullPath)(this.opts.uriResolver, e.baseId, void 0);
  if (Object.keys(e.schema).length > 0 && n === s)
    return Lr.call(this, r, e);
  const i = (0, Oe.normalizeId)(n), a = this.refs[i] || this.schemas[i];
  if (typeof a == "string") {
    const l = Ir.call(this, e, a);
    return typeof l?.schema != "object" ? void 0 : Lr.call(this, r, l);
  }
  if (typeof a?.schema == "object") {
    if (a.validate || fn.call(this, a), i === (0, Oe.normalizeId)(t)) {
      const { schema: l } = a, { schemaId: p } = this.opts, u = l[p];
      return u && (s = (0, Oe.resolveUrl)(this.opts.uriResolver, s, u)), new kr({ schema: l, schemaId: p, root: e, baseId: s });
    }
...
function Lr(e, { baseId: t, schema: r, root: n }) {
  ...
  for (const l of e.fragment.slice(1).split("/")) {
    ...
    !Ac.has(l) && u && (t = (0, Oe.resolveUrl)(this.opts.uriResolver, t, u));
  }
  let i;
...
const Dc = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", Fc = "Meta-schema for $data reference (JSON AnySchema extension proposal)", Mc = "object", Uc = [
  "$data"
], Lc = {
  $data: {
    type: "string",
  ...
  (function(r, n) {
    ...
    var d = u(!1), g = u(!0), C = function() {
      ...
      if (Array.isArray(f)) {
        ...
        return Array.from(f);
    }, E = 2147483647, S = 36, $ = 1, y = 26, T = 38, R = 700, k = 72, D = 128, _ = "-", O = /^xn--/, A = /[^\0-\x7E]/, H = /[\x2E\u3002\uFF0E\uFF61]/g, B = {
      overflow: "Overflow: input needs wider integers to process",
      "not-basic": "Illegal input >= 0x80 (not a basic code point)",
      "invalid-input": "Invalid input"
    }, ae = S - $, Z = Math.floor, be = String.fromCharCode;
    function de(f) {
    ...
    var kt = function(c) {
      ...
      for (var ce = Q > 0 ? Q + 1 : 0; ce < P; ) {
        ...
        var ie = m.length + 1;
        V = v(b - J, ie, J == 0), Z(b / ie) > E - q && de("overflow"), q += Z(b / ie), b %= ie, m.splice(b++, 0, q);
      }
          ...
          for (var qt = c[Symbol.iterator](), ts; !(Ue = (ts = qt.next()).done); Ue = !0) {
            ...
            if (rs < b && ++q > E && de("overflow"), rs == b) {
              for (
                ...
                var or = ar <= V ? $ : ar >= V + y ? y : ar - V;
                if (ir < or)
                  break;
                var ns = ir - or, ss = S - or;
                m.push(be(F(or + ns % ss, 0))), ir = Z(ns / ss);
              }
              m.push(be(F(ir, 0))), V = v(q, Ee, se == W), q = 0, ++se;
            }
          }
        } catch (Vt) {
          rt = !0, ze = Vt;
      ...
      return Qe(c, function(m) {
        return O.test(m) ? I(m.slice(4).toLowerCase()) : m;
      });
    }, h = function(c) {
      return Qe(c, function(m) {
      ...
      if (b) {
        ...
        if (!c.unicodeSupport && (!q || !q.unicodeSupport)) {
          if (m.host && (c.domainHost || q && q.domainHost))
            try {
              m.host = N.toASCII(m.host.replace(P.PCT_ENCODED, x).toLowerCase());
            } catch (V) {
    ...
    function Mt(f, c, m) {
      ...
      return ve(vt(we(f, P), we(c, P), P, !0), P);
    }
    function Xe(f, c) {
      return typeof f == "string" ? f = ve(we(f, c), c) : i(f) === "object" && (f = we(ve(f, c), c)), f;
    }
    function Ut(f, c, m) {
      return typeof f == "string" ? f = ve(we(f, m), m) : i(f) === "object" && (f = ve(f, m)), typeof c == "string" ? c = ve(we(c, m), m) : i(c) === "object" && (c = ve(c, m)), f === c;
    }
    function sr(f, c) {
    ...
    }, zi = {}, Yn = "[A-Za-z0-9\\-\\.\\_\\~\\xA0-\\u200D\\u2010-\\u2029\\u202F-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF]", De = "[0-9A-Fa-f]", Hi = s(s("%[EFef]" + De + "%" + De + De + "%" + De + De) + "|" + s("%[89A-Fa-f]" + De + "%" + De + De) + "|" + s("%" + De + De)), Wi = "[A-Za-z0-9\\!\\$\\%\\'\\*\\+\\-\\^\\_\\`\\{\\|\\}\\~]", Ki = "[\\!\\$\\%\\'\\(\\)\\*\\+\\,\\-\\.0-9\\<\\>A-Z\\x5E-\\x7E]", Gi = n(Ki, '[\\"\\\\]'), Bi = "[\\!\\$\\'\\(\\)\\*\\+\\,\\;\\:\\@]", xi = new RegExp(Yn, "g"), $t = new RegExp(Hi, "g"), Ji = new RegExp(n("[^]", Wi, "[\\.]", '[\\"]', Gi), "g"), Zn = new RegExp(n("[^]", Yn, Bi), "g"), Yi = Zn;
    function Dr(f) {
      var c = x(f);
      ...
      serialize: function(c, m) {
        ...
        if (b) {
          for (var q = 0, V = b.length; q < V; ++q) {
            var Q = String(b[q]), re = Q.lastIndexOf("@"), ce = Q.slice(0, re).replace($t, Dr).replace($t, a).replace(Ji, U), J = Q.slice(re + 1);
            try {
        ...
        var le = [];
        for (var W in te)
          te[W] !== zi[W] && le.push(W.replace($t, Dr).replace($t, a).replace(Zn, U) + "=" + te[W].replace($t, Dr).replace($t, a).replace(Yi, U));
    ...
    M[et.scheme] = et, M[Bn.scheme] = Bn, M[Lt.scheme] = Lt, M[Jn.scheme] = Jn, M[Qn.scheme] = Qn, M[Xn.scheme] = Xn, M[es.scheme] = es, r.SCHEMES = M, r.pctEncChar = U, r.pctDecChars = x, r.parse = we, r.removeDotSegments = Ae, r.serialize = ve, r.resolveComponents = vt, r.resolve = Mt, r.normalize = Xe, r.equal = Ut, r.escapeComponent = sr, r.unescapeComponent = Pe, Object.defineProperty(r, "__esModule", { value: !0 });
  });
})(Br, Br.exports);
var zc = Br.exports;
...
(function(e) {
  ...
  const n = tr, s = rr, i = lt, a = _e, l = G, p = he, u = er, d = X, g = Vc, C = pn, j = (F, v) => new RegExp(F, v);
  j.code = "new RegExp";
  ...
  function R(F) {
    var v, I, w, o, h, N, M, U, x, Y, oe, Ie, ht, It, At, we, Dt, mt, yt, gt, Ft, Ae, ve, vt, Mt;
    const Xe = F.strict, Ut = (v = F.code) === null || v === void 0 ? void 0 : v.optimize, sr = Ut === !0 || Ut === void 0 ? 1 : Ut || 0, Pe = (w = (I = F.code) === null || I === void 0 ? void 0 : I.regExp) !== null && w !== void 0 ? w : j, et = (o = F.uriResolver) !== null && o !== void 0 ? o : C.default;
    return {
      strictSchema: (N = (h = F.strictSchema) !== null && h !== void 0 ? h : Xe) !== null && N !== void 0 ? N : !0,
      ...
      validateFormats: (ve = F.validateFormats) !== null && ve !== void 0 ? ve : !0,
      unicodeRegExp: (vt = F.unicodeRegExp) !== null && vt !== void 0 ? vt : !0,
  ...
  class k {
    constructor(v = {}) {
      this.schemas = {}, this.refs = {}, this.formats = {}, this._compilations = /* @__PURE__ */ new Set(), this._loading = {}, this._cache = /* @__PURE__ */ new Map(), v = this.opts = { ...v, ...R(v) };
      const { es5: I, lines: w } = this.opts.code;
      this.scope = new l.ValueScope({ scope: {}, prefixes: S, es5: I, lines: w }), this.logger = Z(v.logger);
      const o = v.validateFormats;
      v.validateFormats = !1, this.RULES = (0, i.getRules)(), D.call(this, $, v, "NOT SUPPORTED"), D.call(this, y, v, "DEPRECATED", "warn"), this._metaOpts = B.call(this), v.formats && A.call(this), this._addVocabularies(), this._addDefaultMetaSchema(), v.keywords && H.call(this, v.keywords), typeof v.meta == "object" && this.addMetaSchema(v.meta), O.call(this), v.validateFormats = o;
    }
    _addVocabularies() {
      this.addKeyword("$async");
    }
    _addDefaultMetaSchema() {
      const { $data: v, meta: I, schemaId: w } = this.opts;
      let o = g;
      w === "id" && (o = { ...g }, o.id = o.$id, delete o.$id), I && v && this.addMetaSchema(o, o[w], !1);
    }
    defaultMeta() {
      const { meta: v, schemaId: I } = this.opts;
      return this.opts.defaultMeta = typeof v == "object" ? v[I] || v : void 0;
    }
    validate(v, I) {
      let w;
      if (typeof v == "string") {
      ...
      async function N(Y) {
        try {
          ...
          if (!(oe instanceof s.default))
            throw oe;
          return M.call(this, oe), await U.call(this, oe.missingSchema), N.call(this, Y);
        }
      }
    ...
    addSchema(v, I, w, o = this.opts.validateSchema) {
      if (Array.isArray(v)) {
        for (const N of v)
          this.addSchema(N, void 0, w, o);
        return this;
      }
      let h;
      if (typeof v == "object") {
      ...
      return I = (0, p.normalizeId)(I || h), this._checkUnique(I), this.schemas[I] = this._addSchema(v, w, I, o, !0), this;
    }
    // Add schema that will be used to validate other schemas
    // options in META_IGNORE_OPTIONS are alway set to false
    addMetaSchema(v, I, w = this.opts.validateSchema) {
      return this.addSchema(v, I, !0, w), this;
    }
    ...
    getSchema(v) {
      let I;
      for (; typeof (I = _.call(this, v)) == "string"; )
        v = I;
      if (I === void 0) {
        const { schemaId: w } = this.opts, o = new a.SchemaEnv({ schema: {}, schemaId: w });
        if (I = a.resolveSchema.call(this, o, v), !I)
          return;
        this.refs[v] = I;
      }
    ...
    removeSchema(v) {
      ...
      switch (typeof v) {
        ...
        case "string": {
          const I = _.call(this, v);
          return typeof I == "object" && this._cache.delete(I.schema), delete this.schemas[v], delete this.refs[v], this;
        }
        case "object": {
          const I = v;
    ...
    addKeyword(v, I) {
      let w;
      if (typeof v == "string")
        w = v, typeof I == "object" && (this.logger.warn("these parameters are deprecated, see docs for addKeyword"), I.keyword = w);
      else if (typeof v == "object" && I === void 0) {
        if (I = v, w = I.keyword, Array.isArray(w) && !w.length)
      ...
      return (0, d.eachItem)(w, o.type.length === 0 ? (h) => Ze.call(this, h, o) : (h) => o.type.forEach((N) => Ze.call(this, h, o, N))), this;
    }
    getKeyword(v) {
      const I = this.RULES.all[v];
      return typeof I == "object" ? I.definition : !!I;
    }
    // Remove keyword
    removeKeyword(v) {
      const { RULES: I } = this;
      delete I.keywords[v], delete I.all[v];
      for (const w of I.rules) {
        const o = w.rules.findIndex((h) => h.keyword === v);
    ...
    // Add format
    addFormat(v, I) {
      return typeof I == "string" && (I = new RegExp(I)), this.formats[v] = I, this;
    }
    errorsText(v = this.errors, { separator: I = ", ", dataVar: w = "data" } = {}) {
      return !v || v.length === 0 ? "No errors" : v.map((o) => `${w}${o.instancePath} ${o.message}`).reduce((o, h) => o + I + h);
    }
    $dataMetaSchema(v, I) {
      ...
      for (const o of I) {
        ...
        for (const M in w) {
          ...
          if (typeof U != "object")
            continue;
          const { $data: x } = U.definition, Y = N[M];
          x && Y && (N[M] = pt(Y));
        }
      }
      return v;
    }
    _removeAllSchemas(v, I) {
      for (const w in v) {
        const o = v[w];
        (!I || I.test(w)) && (typeof o == "string" ? delete v[w] : o && !o.meta && (this._cache.delete(o.schema), delete v[w]));
      }
    }
    _addSchema(v, I, w, o = this.opts.validateSchema, h = this.opts.addUsedSchema) {
      let N;
      ...
      let U = this._cache.get(v);
      if (U !== void 0)
        return U;
      w = (0, p.normalizeId)(N || w);
      const x = p.getSchemaRefs.call(this, v, w);
      return U = new a.SchemaEnv({ schema: v, schemaId: M, meta: I, baseId: w, localRefs: x }), this._cache.set(U.schema, U), h && !w.startsWith("#") && (w && this._checkUnique(w), this.refs[w] = U), o && this.validateSchema(v, !0), U;
    }
    _checkUnique(v) {
    ...
    _compileSchemaEnv(v) {
      if (v.meta ? this._compileMetaSchema(v) : a.compileSchema.call(this, v), !v.validate)
        throw new Error("ajv implementation error");
      return v.validate;
    }
  ...
  function D(F, v, I, w = "error") {
    for (const o in F) {
      const h = o;
      h in v && this.logger[w](`${I}: option ${o}. ${F[h]}`);
    }
  }
  function _(F) {
  ...
  function H(F) {
    ...
    for (const v in F) {
      const I = F[v];
      I.keyword || (I.keyword = v), this.addKeyword(I);
    }
  }
  function B() {
    const F = { ...this.opts };
  ...
  function Ze(F, v, I) {
    ...
    const { RULES: h } = this;
    let N = o ? h.post : h.rules.find(({ type: U }) => U === I);
    if (N || (N = { type: I, rules: [] }, h.rules.push(N)), h.keywords[F] = !0, !v)
      return;
    const M = {
      keyword: F,
      definition: {
    ...
    v.before ? Qe.call(this, N, M, v.before) : N.rules.push(M), h.all[F] = M, (w = v.implements) === null || w === void 0 || w.forEach((U) => this.addKeyword(U));
  }
  function Qe(F, v, I) {
    const w = F.rules.findIndex((o) => o.keyword === I);
    w >= 0 ? F.rules.splice(w, 0, v) : (F.rules.push(v), this.logger.warn(`rule ${I} is not defined`));
  }
  function ft(F) {
    let { metaSchema: v } = F;
    v !== void 0 && (F.$data && this.opts.$data && (v = pt(v)), F.validateSchema = this.compile(v, !0));
  }
  const kt = {
...
const Wc = rr, Ss = K, $e = G, Pt = Ve, Ts = _e, cr = X, Kc = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
    ...
    if (d === void 0)
      throw new Wc.default(n.opts.uriResolver, s, r);
    ...
    function g() {
      ...
      return yr(e, (0, $e._)`${E}.validate`, u, u.$async);
    }
    function C(E) {
      const S = Si(e, E);
      yr(e, S, E, E.$async);
    ...
    function j(E) {
      const S = t.scopeValue("schema", l.code.source === !0 ? { ref: E, code: (0, $e.stringify)(E) } : { ref: E }), $ = t.name("valid"), y = e.subschema({
        schema: E,
        dataTypes: [],
        schemaPath: $e.nil,
        topSchemaRef: S,
...
ut.getValidate = Si;
function yr(e, t, r, n) {
  const { gen: s, it: i } = e, { allErrors: a, schemaEnv: l, opts: p } = i, u = p.passContext ? Pt.default.this : $e.nil;
  n ? d() : g();
  function d() {
    if (!l.$async)
    ...
    const E = s.let("valid");
    s.try(() => {
      s.code((0, $e._)`await ${(0, Ss.callValidateCode)(e, t, u)}`), j(t), a || s.assign(E, !0);
    }, (S) => {
      s.if((0, $e._)`!(${S} instanceof ${i.ValidationError})`, () => s.throw(S)), C(S), a || s.assign(E, !1);
    }), e.ok(E);
  }
  function g() {
  ...
  function C(E) {
    const S = (0, $e._)`${E}.errors`;
    s.assign(Pt.default.vErrors, (0, $e._)`${Pt.default.vErrors} === null ? ${S} : ${Pt.default.vErrors}.concat(${S})`), s.assign(Pt.default.errors, (0, $e._)`${Pt.default.vErrors}.length`);
  }
  function j(E) {
    var S;
    if (!i.opts.unevaluated)
      return;
    const $ = (S = r?.validate) === null || S === void 0 ? void 0 : S.evaluated;
    if (i.props !== !0)
      if ($ && !$.dynamicProps)
        $.props !== void 0 && (i.props = cr.mergeEvaluated.props(s, $.props, i.props));
      else {
        const y = s.var("props", (0, $e._)`${E}.evaluated.props`);
        i.props = cr.mergeEvaluated.props(s, y, i.props, $e.Name);
      }
    if (i.items !== !0)
      if ($ && !$.dynamicItems)
        $.items !== void 0 && (i.items = cr.mergeEvaluated.items(s, $.items, i.items));
      else {
        const y = s.var("items", (0, $e._)`${E}.evaluated.items`);
        i.items = cr.mergeEvaluated.items(s, y, i.items, $e.Name);
      }
  }
}
ut.callRef = yr;
...
const it = G, Xc = X, el = wn, tl = {
  ...
  error: tl,
  code(e) {
    const { keyword: t, data: r, schemaCode: n, it: s } = e, i = t === "maxLength" ? it.operators.GT : it.operators.LT, a = s.opts.unicode === !1 ? (0, it._)`${r}.length` : (0, it._)`${(0, Xc.useFunc)(e.gen, el.default)}(${r})`;
...
const nl = K, Er = G, sl = {
  ...
  error: sl,
  code(e) {
    const { data: t, $data: r, schema: n, schemaCode: s, it: i } = e, a = i.opts.unicodeRegExp ? "u" : "", l = r ? (0, Er._)`(new RegExp(${s}, ${a}))` : (0, nl.usePattern)(e, n);
    ...
    if (a.allErrors ? u() : d(), l.strictRequired) {
      ...
      for (const S of r)
        if (j?.[S] === void 0 && !E.has(S)) {
          const $ = a.schemaEnv.baseId + a.errSchemaPath, y = `required property "${S}" is not defined at "${$}" (strictRequired)`;
          (0, cl.checkStrictMode)(a, y, a.opts.strictRequired);
        }
    }
    function u() {
      if (p || i)
...
const qr = er, pe = G, pl = X, hl = nr, ml = {
  ...
  code(e) {
    ...
    function C(E, S) {
      const $ = t.name("item"), y = (0, qr.checkDataTypes)(u, $, l.opts.strictNumbers, qr.DataType.Wrong), T = t.const("indices", (0, pe._)`{}`);
      t.for((0, pe._)`;${E}--;`, () => {
        t.let($, (0, pe._)`${r}[${E}]`), t.if(y, (0, pe._)`continue`), u.length > 1 && t.if((0, pe._)`typeof ${$} == "string"`, (0, pe._)`${$} += "_"`), t.if((0, pe._)`typeof ${T}[${$}] == "number"`, () => {
          t.assign(S, (0, pe._)`${T}[${$}]`), e.error(), t.assign(p, !1).break();
        }).code((0, pe._)`${T}[${$}] = ${E}`);
      });
    }
    function j(E, S) {
      const $ = (0, pl.useFunc)(t, hl.default), y = t.name("outer");
      t.label(y).for((0, pe._)`;${E}--;`, () => t.for((0, pe._)`${S} = ${E}; ${S}--;`, () => t.if((0, pe._)`${$}(${r}[${E}], ${r}[${S}])`, () => {
...
const xr = G, gl = X, vl = nr, $l = {
  ...
  code(e) {
    ...
    n || i && typeof i == "object" ? e.fail$data((0, xr._)`!${(0, gl.useFunc)(t, vl.default)}(${r}, ${s})`) : e.fail((0, xr._)`${i} !== ${r}`);
  }
};
Rn.default = _l;
var On = {};
Object.defineProperty(On, "__esModule", { value: !0 });
const Wt = G, wl = X, bl = nr, Pl = {
  ...
  code(e) {
    ...
    let p;
    const u = () => p ?? (p = (0, wl.useFunc)(t, bl.default));
    let d;
    if (l || n)
...
const Sl = vn, Tl = $n, Rl = _n, Ol = bn, Nl = Pn, Cl = En, jl = Sn, kl = Tn, Il = Rn, Al = On, Dl = [
  // number
  Sl.default,
  Tl.default,
  // string
...
Ct.validateAdditionalItems = Oi;
Ct.default = Ml;
var Cn = {}, jt = {};
Object.defineProperty(jt, "__esModule", { value: !0 });
jt.validateTuple = void 0;
const Rs = G, gr = X, Ul = K, Ll = {
  keyword: "items",
  type: "array",
  ...
  code(e) {
    ...
    r.items = !0, !(0, gr.alwaysValidSchema)(r, t) && e.ok((0, Ul.validateArray)(e));
  }
};
function Ni(e, t, r = e.schema) {
  ...
  function d(g) {
    ...
    if (C.strictTuples && !S) {
      const $ = `"${a}" is ${E}-tuple, but minItems or maxItems/${t} are not specified or different at path "${j}"`;
      (0, gr.checkStrictMode)(l, $, C.strictTuples);
    }
  }
}
jt.validateTuple = Ni;
...
const Os = G, zl = X, Hl = K, Wl = Ct, Kl = {
  ...
  code(e) {
    ...
    n.items = !0, !(0, zl.alwaysValidSchema)(n, t) && (s ? (0, Wl.validateAdditionalItems)(e, s) : e.ok((0, Hl.validateArray)(e)));
  }
};
jn.default = Gl;
var kn = {};
...
const Se = G, lr = X, Bl = {
  ...
  code(e) {
    ...
    function C() {
      const S = t.name("_valid"), $ = t.let("count", 0);
      j(S, () => t.if(S, () => E($)));
    }
    function j(S, $) {
      t.forRange("i", 0, d, (y) => {
...
(function(e) {
  ...
  function a(p, u = p.schema) {
    ...
    for (const E in u) {
      ...
      if (S.length === 0)
        continue;
      const $ = (0, n.propertyInData)(d, g, E, C.opts.ownProperties);
      p.setParams({
        property: E,
        depsCount: S.length,
        deps: S.join(", ")
      ...
      }) : (d.if((0, t._)`${$} && (${(0, n.checkMissingProp)(p, S, j)})`), (0, n.reportMissingProp)(p, j), d.else());
    }
  }
  ...
  function l(p, u = p.schema) {
    ...
    for (const S in u)
      (0, r.alwaysValidSchema)(j, u[S]) || (d.if(
        ...
        () => {
          const $ = p.subschema({ keyword: C, schemaProp: S }, E);
          p.mergeValidEvaluated($, E);
        },
        () => d.var(E, !0)
        // TODO var
      ), p.ok(E));
...
const ur = K, Re = G, Ql = Ve, dr = X, Xl = {
  ...
  code(e) {
    ...
    g(), e.ok((0, Re._)`${i} === ${Ql.default.errors}`);
    function g() {
      t.forIn("key", s, ($) => {
        !u.length && !d.length ? E($) : t.if(C($), () => E($));
      });
    }
    function C($) {
      let y;
      if (u.length > 8) {
        ...
        y = (0, ur.isOwnProperty)(t, T, $);
      } else
        u.length ? y = (0, Re.or)(...u.map((T) => (0, Re._)`${$} === ${T}`)) : y = Re.nil;
      return d.length && (y = (0, Re.or)(y, ...d.map((T) => (0, Re._)`${(0, ur.usePattern)(e, T)}.test(${$})`))), (0, Re.not)(y);
    }
    function j($) {
      t.code((0, Re._)`delete ${s}[${$}]`);
    }
    function E($) {
      ...
      if (typeof r == "object" && !(0, dr.alwaysValidSchema)(a, r)) {
        ...
        p.removeAdditional === "failing" ? (S($, y, !1), t.if((0, Re.not)(y), () => {
          e.reset(), j($);
        })) : (S($, y), l || t.if((0, Re.not)(y), () => t.break()));
      }
    }
    function S($, y, T) {
      const R = {
...
const tu = Ne, Ns = K, Vr = X, Cs = Ar, ru = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, parentSchema: n, data: s, it: i } = e;
    i.opts.removeAdditional === "all" && n.additionalProperties === void 0 && Cs.default.code(new tu.KeywordCxt(i, Cs.default, "additionalProperties"));
    const a = (0, Ns.allSchemaProperties)(r);
    for (const g of a)
...
const js = K, fr = G, ks = X, Is = X, nu = {
  ...
  code(e) {
    ...
    function j(S) {
      for (const $ in u)
        new RegExp(S).test($) && (0, ks.checkStrictMode)(i, `property ${$} matches pattern ${S} (use allowMatchingProperties)`);
    }
    function E(S) {
      t.forIn("key", n, ($) => {
        t.if((0, fr._)`${(0, js.usePattern)(e, S)}.test(${$})`, () => {
          ...
          }, d), i.opts.unevaluated && g !== !0 ? t.assign((0, fr._)`${g}[${$}]`, !0) : !y && !i.allErrors && t.if((0, fr.not)(d), () => t.break());
        });
      });
    }
  }
...
const vr = G, cu = X, lu = {
  ...
  code(e) {
    ...
    function u() {
      i.forEach((d, g) => {
        let C;
        (0, cu.alwaysValidSchema)(s, d) ? t.var(p, !0) : C = e.subschema({
          keyword: "oneOf",
          schemaProp: g,
          compositeRule: !0
        }, p), g > 0 && t.if((0, vr._)`${p} && ${a}`).assign(a, !1).assign(l, (0, vr._)`[${l}, ${g}]`).else(), t.if(p, () => {
          t.assign(a, !0), t.assign(l, g), C && e.mergeEvaluated(C, vr.Name);
        });
      });
    }
  }
...
const mu = X, yu = {
  ...
  code({ keyword: e, parentSchema: t, it: r }) {
    t.if === void 0 && (0, mu.checkStrictMode)(r, `"${e}" without "if" is ignored`);
  }
};
Vn.default = yu;
Object.defineProperty(Nn, "__esModule", { value: !0 });
const gu = Ct, vu = Cn, $u = jt, _u = jn, wu = kn, bu = Ci, Pu = In, Eu = Ar, Su = An, Tu = Dn, Ru = Fn, Ou = Mn, Nu = Un, Cu = Ln, ju = qn, ku = Vn;
function Iu(e = !1) {
  const t = [
    // any
    Ru.default,
  ...
  return e ? t.push(vu.default, _u.default) : t.push(gu.default, $u.default), t.push(wu.default), t;
}
Nn.default = Iu;
var zn = {}, Hn = {};
  ...
  code(e, t) {
    ...
    function C() {
      const E = r.scopeValue("formats", {
        ref: g.formats,
        code: p.code.formats
      }), S = r.const("fDef", (0, ue._)`${E}[${a}]`), $ = r.let("fType"), y = r.let("format");
      r.if((0, ue._)`typeof ${S} == "object" && !(${S} instanceof RegExp)`, () => r.assign($, (0, ue._)`${S}.type || "string"`).assign(y, (0, ue._)`${S}.validate`), () => r.assign($, (0, ue._)`"string"`).assign(y, S)), e.fail$data((0, ue.or)(T(), R()));
      function T() {
    ...
    function j() {
      ...
      function R(D) {
        const _ = D instanceof RegExp ? (0, ue.regexpCode)(D) : p.code.formats ? (0, ue._)`${p.code.formats}${(0, ue.getProperty)(i)}` : void 0, O = r.scopeValue("formats", { key: i, ref: D, code: _ });
        return typeof D == "object" && !(D instanceof RegExp) ? [D.type || "string", D.validate, (0, ue._)`${O}.validate`] : ["string", D, O];
      }
      function k() {
        ...
        return typeof $ == "function" ? (0, ue._)`${y}(${n})` : (0, ue._)`${y}.test(${n})`;
      }
    }
  }
};
...
Object.defineProperty(hn, "__esModule", { value: !0 });
const Uu = mn, Lu = gn, qu = Nn, Vu = zn, Ds = Nt, zu = [
  Uu.default,
  Lu.default,
  (0, qu.default)(),
  Vu.default,
...
Object.defineProperty(Wn, "__esModule", { value: !0 });
const Et = G, Yr = Ii, Fs = _e, Hu = X, Wu = {
  ...
  code(e) {
    ...
    function C() {
      ...
      for (let k = 0; k < a.length; k++) {
        let D = a[k];
        D?.$ref && !(0, Hu.schemaHasRulesButRef)(D, i.self.RULES) && (D = Fs.resolveRef.call(i.self, i.schemaEnv.root, i.baseId, D?.$ref), D instanceof Fs.SchemaEnv && (D = D.schema));
...
Wn.default = Ku;
const Gu = "http://json-schema.org/draft-07/schema#", Bu = "http://json-schema.org/draft-07/schema#", xu = "Core schema meta-schema", Ju = {
  schemaArray: {
    type: "array",
    minItems: 1,
    items: {
...
(function(e, t) {
  ...
  const r = Xs, n = hn, s = Wn, i = Qu, a = ["/properties"], l = "http://json-schema.org/draft-07/schema";
...
var Xu = Wr.exports;
const ed = /* @__PURE__ */ oo(Xu), td = "http://json-schema.org/schema", rd = "#/definitions/Blueprint", nd = {
  Blueprint: {
    type: "object",
    properties: {
      landingPage: {
...
function ad(e, {
  ...
  e = {
    ...e,
    steps: (e.steps || []).filter(ld)
  };
  const { valid: s, errors: i } = cd(e);
  if (!s) {
    const u = new Error(
...
const od = new ed({ discriminator: !0 });
let pr;
function cd(e) {
  pr = od.compile(sd);
  const t = pr(e);
 ...
 */
const Ai = Symbol("Comlink.proxy"), pd = Symbol("Comlink.endpoint"), hd = Symbol("Comlink.releaseProxy"), zr = Symbol("Comlink.finalizer"), $r = Symbol("Comlink.thrown"), Di = (e) => typeof e == "object" && e !== null || typeof e == "function", md = {
...
function Kn(e, t = globalThis, r = ["*"]) {
  t.addEventListener("message", function n(s) {
    ...
    Promise.resolve(u).catch((d) => ({ value: d, [$r]: 0 })).then((d) => {
      const [g, C] = Or(d);
...
function Ls(e) {
  const t = e.map(Or);
  return [t.map((r) => r[0]), wd(t.map((r) => r[1]))];
}
...
function qi(e) {
  Td();
  const t = e instanceof Worker ? e : Pd(e), r = Gn(t), n = Vi(r);
  return new Proxy(n, {
    get: (s, i) => i === "isConnected" ? async () => {
      for (let a = 0; a < 10; a++)
        try {
          await Sd(r.isConnected(), 200);
          break;
        } catch {
        }
    } : r[i]
...
async function Rd({
  ...
  return await fd(a, l), n.finish(), l;
}
function Od(e) {
...
export {
  ...
  Cd as SupportedPHPVersionsList,
  Hs as activatePlugin,
  Ws as activateTheme,
  ta as applyWordPressPatches,
  ad as compileBlueprint,
